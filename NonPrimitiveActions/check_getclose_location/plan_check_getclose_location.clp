...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defrule check_failure-check_getclose_location-decompose
...
(defrule check_failure-check_getclose_location-detected-not_connected-MVN-PLN
	...
	(retract ?cmc)
	(assert
		(task (plan ?planName) (action_type wait_user_start_module) (params "MVN-PLN") (step (- ?step 1) $?steps) (parent ?pt))
	)
)
...
(defrule check_failure-check_getclose_location-detected-location_does_NOT_exist
	...
	(retract ?cmc ?cle)
	(assert
		(task (plan ?planName) (action_type wait_user_set_location) (params ?location) (step (- ?step 1) $?steps) (parent ?pt))
	)
)
...
(defrule check_failure-check_getclose_location-finished
	(task (id ?t) (plan ?planName) (action_type check_getclose_location) (params ?location) (step ?step $?steps) (parent ?pt))
	(task_status ?t ?)
	(active_task ?t)
	?cle <-(checked_location_exists)
