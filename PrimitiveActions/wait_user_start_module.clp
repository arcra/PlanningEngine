(defrule wait_user_start_module-start_timer
	...
	(not (BB_timer wait_user_start_module))
...
(defrule wait_user_start_module-send_speech
	(task (id ?t) (plan ?planName) (action_type wait_user_start_module) (params ?module) (step ?step $?steps) (parent ?pt))
	(active_task ?t)
	(not
		(task_status ?t ?)
	)
	...
	=>
	(assert
		(task (plan ?planName) (action_type spg_say) (params "Please start the module: " ?module ", so I can continue with the execution.") (step (- ?step 1) $?steps) (parent ?pt))
