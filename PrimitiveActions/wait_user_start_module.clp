...
(defrule wait_user_start_module-send_speech
	(task (id ?t) (plan ?planName) (action_type wait_user_start_module) (params ?module) (step $?steps))
	(active_task ?t)
	(not (task_status ?t ?))
	(not (cancel_active_tasks))
	...
	=>
	(assert
		(task (plan ?planName) (action_type spg_say) (params "Please start the module: " ?module ", so I can continue with the execution.") (step 1 $?steps) (parent ?t))
		(speech_notification_sent wait_user_start_module)
	)
