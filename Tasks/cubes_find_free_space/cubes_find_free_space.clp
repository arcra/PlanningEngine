...
(defrule cubes_find_free_space-free_space_found
	...
	(retract ?ffs)
	(assert
		(cubes_free_space ?side (min ?x 0.21) ?y (max ?z 0.65))
...
(defrule cubes_find_free_space-no_free_space-left-clip_left
	...
	(retract ?ffs)
	(assert
		(finding_free_space left 0.43)
	)
)

(defrule cubes_find_free_space-no_free_space-left-start_search_right
	(task (id ?t) (plan ?planName) (action_type cubes_find_free_space) (params left) (step $?steps))
	(active_task ?t)
	(not (task_status ?t ?))
	(not (cancel_active_tasks))
...
(defrule cubes_find_free_space-no_free_space-right-clip_right
	...
	(retract ?ffs)
	(assert
		(finding_free_space right -0.43)
	)
)

(defrule cubes_find_free_space-no_free_space-right-start_search_left
	(task (id ?t) (plan ?planName) (action_type cubes_find_free_space) (params right) (step $?steps))
	(active_task ?t)
	(not (task_status ?t ?))
	(not (cancel_active_tasks))
